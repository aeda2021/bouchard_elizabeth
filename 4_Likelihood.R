...
bern.draws <- rbinom(1000, 1, 0.2) # 1000 observations of 1 trial   #1000 bernoulli trials
hist(bern.draws)
...
binom.draws <- rbinom(10000, 10, 0.2) # 10000 observations of 10 trials #0.2 is probability of success for a single trial
hist(binom.draws)
...
# In this case, the binomial process involves 10 trials, so there can be 0-10 successes, or 11 outcomes.
...
#We could be very confident in this MLE of 0.2 because our observation would match our expectation.
...
# b) I would estimate the 95% CI for p to be about: 0.05 and 0.45. The bounds of the 95% CI are
...
# how can we increase our confidence of our estimate?
# ...
#
...
#
# The first method we'll examine is the likelihood ratio test. This method is powerful because it takes advantage of
...
# the likelihood ratio test allows you to do that, *for nested models.*
